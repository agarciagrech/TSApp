...
public class ClientUtilities {
    ...
    private static void registerDoctor(BufferedReader br, PrintWriter pw) throws Exception {
    ...
    private static void registerPatient(BufferedReader br, PrintWriter pw) throws Exception {
        //autogenerate username
        ...
        userman.addUser(user);
        Utilities.CommunicationWithClient.sendUser(pw, user);
        patientman.createLinkUserPatient(user.getUserId(), p.getUserId());
    }
   
    private static void login(BufferedReader bf, PrintWriter pw) throws Exception{
        User u = utilities.CommunicationWithServer.receiveUser(bf);
